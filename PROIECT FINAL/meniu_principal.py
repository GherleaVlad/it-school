...
class MeniuPrincipal(tkinter.Tk):
    ...
    def deschide_meniu_principal_admin(self):
        ...
        tkinter.Button(frame_pacienti,text='INTRODUCERE PACIENT NOU',width=25,height=3).pack(padx=20,pady=12)
        tkinter.Button(frame_pacienti,text='RAPOARTE',width=25,height=3).pack(padx=20,pady=12)
        ...
        tkinter.Button(frame_administrare,text='OPERATORI',width=30,height=3).pack(padx=20,pady=12)
